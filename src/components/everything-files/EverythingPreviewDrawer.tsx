...
type PreviewType = "image" | "audio" | "video" | "text" | "markdown" | "pdf";
...
export function EverythingPreviewDrawer({ file, isOpen, onClose }: { file: EverythingFileResult | null; isOpen: boolean; onClose: () => void }) {
  ...
  const fileUrl = "/api/everything/preview?filepath=" + encodeURIComponent(file.fullPath);
